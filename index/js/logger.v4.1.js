...
function _trk_make_code(_TRK_SERVER,_TRK_U) {
    ...
    var adKeyVal = "";
    if(bFrm) {
		var adParams = new Array("OVKEY", "OVRAW", "netpia", "logger_kw", "source", "keywd", "NVADID", "NVAR", "NVADRANK", "NVADKWD", "NVKWD", "DMCOL", "DMKW", "DMSKW", "DWIT", "DWIC", "gad", "gclid", "gkw", "rcsite", "rctype", "rc_code", "_C_", "_G_", "n_ad_group", "n_media", "n_ad", "n_keyword", "n_query", "n_rank", "n_keyword_id");
...
//2019.08.07. bluetaiji Appier localstorge »ç¿ë
var isBSFlag = "";
...
if(_TRK_LID == "13766" || _TRK_LID =="54181" || _TRK_LID == "7577" || _TRK_LID == "54183" || _TRK_LID == "55141" || _TRK_LID == "31526" || _TRK_LID == "40233" || _TRK_LID == "101358" || _TRK_LID == "21622" || _TRK_LID == "54182" || _TRK_LID == "101383" || _TRK_LID == "42931" || _TRK_LID == "8390" || _TRK_LID == "101331" || _TRK_LID == "101332") {
    _suppress_dmp = true;
}
...
var _trk_code_nhn="//web.archive.org/web/20191003113554/https://adlc-exchange.toast.com/sendid?sid=bizspring.co.kr&uid="+_TRK_DPUID;
var _trk_img_nhn=new Image();
//2017.04.01. k3363. About DMP For Nas
var _trk_code_nas=document.location.protocol.indexOf("https")!=-1?"//web.archive.org/web/20191003113554/https://sync.admixer.co.kr:4450/idsync?pid=2&uid="+_TRK_DPUID:"//web.archive.org/web/20191003113554/https://sync.admixer.co.kr:8100/idsync?pid=2&uid="+_TRK_DPUID;
...
var _trk_code_skp="//web.archive.org/web/20191003113554/https://idm.skplanet.com/pixel?nid=10&uid="+_TRK_DPUID+"&url="+_skp_return_url;
var _trk_img_skp=new Image();

//2018.04.06. k3363. About TAME
var _trk_img_tame=new Image();
//2019.03.27. k3363. About DMP For APPIER
var _app_return_url = encodeURIComponent("//web.archive.org/web/20191003113554/https://tm.bizspring.co.kr/appier.php?bzuid="+_TRK_DPUID+"&appieruid=%%APPIER_UID%%");
var _trk_code_app="//web.archive.org/web/20191003113554/https://extcm.c.appier.net/bizspring?bzuid="+_TRK_DPUID+"&url="+_app_return_url;
...
//		setTimeout(function(_trk_code_base){_trk_img_base.src=_trk_code_base;}(_trk_code_base),10);
        ...
        if(typeof _TRK_DPUID!="undefined"&&_TRK_DPUID!=""){
            if(!_suppress_dmp) {
    			...
    			if(isBSFlag == null || isBSFlag == "") {
					try{
						setTimeout(function(){_trk_img_nhn.src=_trk_code_nhn;},10);
						setTimeout(function(){_trk_img_skp.src=_trk_code_skp;},10);
    ...
    if(typeof _TRK_DPUID!="undefined"&&_TRK_DPUID!=""){
        if(!_suppress_dmp) {
    		...
    		if(isBSFlag == null || isBSFlag == "") {
				try{
					document.write('<img src=\"'+_trk_code_nhn+'\" height=\"0\" width=\"0\">');
					document.write('<img src=\"'+_trk_code_skp+'\" height=\"0\" width=\"0\">');
...
/*
     ...
     INTERNET ARCHIVE ON 01:28:26 Jul 09, 2023.
...
/*
playback timings (ms):
  captures_list: 933.905
  exclusion.robots: 0.095
  exclusion.robots.policy: 0.087
  cdx.remote: 0.058
  esindex: 0.009
  LoadShardBlock: 282.631 (3)
  PetaboxLoader3.resolve: 202.985 (3)
  PetaboxLoader3.datanode: 171.106 (4)
  load_resource: 104.395
*/